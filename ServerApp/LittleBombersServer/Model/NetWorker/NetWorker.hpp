...
private:
    ...
    int __operation = OPERATION_NONE;
    int __buffer_operation = OPERATION_NONE;
...
public:
    const QByteArray M_END_MESSAGE = "\"status\" = \"end_message\"";
    const QByteArray M_CLOSE_CONNECTION = "\"status\" = \"close_connection\"";
    ...
    void setMessage(QByteArray message, OPERATION_MODE mode = OPERATION_NONE);
